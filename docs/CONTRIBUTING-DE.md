# Beiträge zu MizeMoon

MizeMoon begrüßt Beiträge von jedem. Hier sind die Richtlinien, wenn Sie uns
helfen möchten:

## Beiträge

Beiträge zu MizeMoon oder seinen Abhängigkeiten sollten in Form von Pull
...
- Wenn Ihr Patch nicht begutachtet wird oder Sie eine bestimmte Person zur
  ...
  per [E-Mail](mailto:info@mizemoon.ir) um eine Begutachtung bitten.
...
MizeMoon-Mitarbeiter arbeiten häufig im [Discord](https://discord.gg/nDceKgxnkV).
