...
#
# Script to build F-Droid release of MizeMoon
#
# Copyright (C) 2024, The MizeMoon Authors
...
#
# - versionName from https://github.com/vanaboom/mizemoon/releases/download/fdroid-version/mizemoon-version.txt
# - versionCode from https://github.com/vanaboom/mizemoon/releases/download/fdroid-version/mizemoon-version.txt
...
prebuild)
	...
	# Install Flutter version for MizeMoon library build
